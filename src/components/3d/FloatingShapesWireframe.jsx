...
export default function FloatingShapesWireframe() {
  ...
  const shapes = isMobile ? [
    { geometry: 'sphere', color: '#8b5cf6', position: [-2, 1.5, 0], rotationSpeed: { x: 0.004, y: 0.008 }, scale: 0.7 },
    { geometry: 'box', color: '#ec4899', position: [2, -1, -1], rotationSpeed: { x: 0.008, y: 0.004 }, scale: 0.6 },
    { geometry: 'torus', color: '#06b6d4', position: [0, 0, 1.5], rotationSpeed: { x: 0.006, y: 0.006 }, scale: 0.5 },
  ] : [
